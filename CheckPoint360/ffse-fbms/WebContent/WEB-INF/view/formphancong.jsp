				...
				<div class="col-xs-12">
					<div class="card">
						...
						<div class="card-body collapse in">
							...
							<form:form action="phancongdanhgia" method="post"
								modelAttribute="phancong">
									...
									<table class="table">
										...
										<tbody>
											...
											<c:forEach items="${DanhSachNhanVien}" var="ds">
												<tr>
													<td>${ds.maNhanVien}<form:input class="form-control"
															id="basicInput" value="1" type="text"
															 path="nhanVienDuocDanhGia"
															 /> <form:input class="form-control"
															id="basicInput" value="FFSE" type="text" path="phongBan"
															 />
													</td>
													<td>${ds.hoDem}</td>
													<td>${ds.ten}</td>
													<td><form:select name="Events" path="nhanVienDanhGia1">
															...
															<c:forEach items="${DanhSachNhanVien}" var="ds">
																<form:option value="${ds.maNhanVien}">${ds.maNhanVien}</form:option>
															</c:forEach>
														</form:select></td>
								...
								<%-- 	<form:input class="form-control" id="basicInput" value="1" type="text" 
									path="nhanVienDuocDanhGia" />
								<form:input class="form-control" id="basicInput" value="FFSE"
									type="text" path="phongBan" /> --%>
