...
--
-- Host: localhost
-- Generation Time: Oct 04, 2018 at 03:41 AM
...
CREATE TABLE IF NOT EXISTS `ho_so` (
  ...
  `ma_hop_dong` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `ca_lam_viec` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `vi_tri` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `sdt` int(11) NOT NULL,
  `so_hop_dong` int(11) NOT NULL,
  `ma_gioi_tinh` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `tinh_trang_hon_nhan` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `ten_bo` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `ten_me` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `trinh_do_chuyen_mon` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `kinh_nghiem` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `note` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `img` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `dia_chi_hien_tai` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `dia_chi_thuong_tru` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `lien_he_khac` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `ten_ngan_hang` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `ho_so` (`ma_nhan_vien`, `ho_ten`, `ma_vai_tro`, `ma_phong_ban`, `luong`, `ma_hop_dong`, `ca_lam_viec`, `vi_tri`, `sdt`, `so_hop_dong`, `ma_gioi_tinh`, `tinh_trang_hon_nhan`, `ten_bo`, `ten_me`, `trinh_do_chuyen_mon`, `kinh_nghiem`, `note`, `img`, `dia_chi_hien_tai`, `dia_chi_thuong_tru`, `lien_he_khac`, `ten_ngan_hang`, `so_tai_khoan`, `email`, `ngay_tham_gia`, `ngay_sinh`, `is_delete`) VALUES
(00001, 'Trần Lâm Phi Long', 'VT02', 'PNS', 2345, 'FFSE', 'đêm', 'PM', 11111, 123456, 'Nữ', 'Rồi', 'Bố', 'Mẹ', 'java', 'NO', 'NO', 'WIN_20170811_18_14_54_Pro.jpg', 'Ngũ Hành Sơn', 'Đại Lộc', '01294067734', 'Alibaba', 12, 'long0202@gmail.com', '2018-10-01', '2018-09-05', 0),
(00010, 'Trần Lâm Phi Long', 'VT01', 'PGD', 10000000, 'FFSE1702021', 'ngày', 'developer', 2134567, 123456789, 'Nam', 'Rồi', 'bố', 'mẹ', 'java', 'không có', 'Cố Gắng Lên', 'WIN_20170811_18_14_54_Pro.jpg', 'Đà Nẳng', 'QuangNam', 'https://www.facebook.com/', 'Bank Bank', 12345678, 'long@gmail.com', '2013-01-12', '2013-01-12', 0),
(00011, 'Trần Lâm Phi Win', 'VT03', 'PNS', 2345, 'FFSE', 'đêm', 'teacher', 11111, 123456, 'Nữ', 'Rồi', 'Bố', 'Mẹ', 'java', 'NO', 'NO', 'WIN_20170811_18_14_54_Pro.jpg', 'Ngũ Hành Sơn', 'Đại Lộc', '01294067734', 'Alibaba', 12, 'long0202@gmail.com', '2018-10-01', '2018-09-04', 0),
(00012, 'Trần Lâm', 'VT02', 'PNS', 2345, 'FFSE', 'đêm', 'teacher', 11111, 123456, 'Nữ', 'NO', 'Bố', 'Mẹ', 'java', 'NO', 'NO', NULL, 'Ngũ Hành Sơn', 'Đại Lộc', '01294067734', 'Alibaba', 12, 'long0202@gmail.com', '2018-10-01', '2018-10-01', 1),
(00013, 'Trần Lâm ahhi', 'VT03', 'PDA4', 2345, 'FFSE', 'đêm', 'tầng 3', 11111, 123456, 'Nữ', 'Rồi', 'Bố', 'Mẹ', 'java', 'NO', 'NO', 'WIN_20170811_18_14_54_Pro.jpg', 'Ngũ Hành Sơn', 'Đại Lộc', '01294067734', 'Alibaba', 12, 'long0202@gmail.com', '2018-10-01', '2018-10-01', 0),
(00014, 'Trần Lâm Phi Long', 'VT02', 'PDA2', 2345, 'FFSE', 'đêm', 'PM', 11111, 123456, 'Nam', 'Chưa', 'Bố', 'Mẹ', 'java', 'NO', 'NO', 'bai1.png', 'Ngũ Hành Sơn', 'Đại Lộc', '01294067734', 'Alibaba', 12, 'ffse1702021@st.fasttrack.edu.vn', '2018-10-02', '2018-10-02', 1),
(00015, 'Đăng khoa', 'VT02', 'PDA1', 2345, 'FFSE', 'đêm', 'PM', 11111, 123456, 'Thứ 3', 'Chưa', 'Bố', 'Mẹ', 'java', 'NO', 'NO', '1.jpg', 'Ngũ Hành Sơn', 'Đại Lộc', '01294067734', 'Alibaba', 12, 'ffse1702021@st.fasttrack.edu.vn', '2018-10-03', '2018-10-02', 0),
(00016, 'Văn Lộc', 'VT02', 'PDA1', 2345, '32', 'đêm', 'PM', 11111, 123456, 'Nữ', 'Rồi', 'Bố', 'Mẹ', 'java', 'NO', 'NO', 'WIN_20170811_18_14_54_Pro.jpg', 'Ngũ Hành Sơn', 'Đại Lộc', '01294067734', 'Alibaba', 12, 'ffse1702021@st.fasttrack.edu.vn', '2018-10-02', '2018-10-02', 1),
(00017, 'Trần HI', 'VT03', 'PDA3', 2345, 'FFSE', 'đêm', 'teacher', 11111, 123456, 'Thứ 3', 'Rồi', 'Bố', 'Mẹ', 'java', 'NO', 'NO', '1.jpg', 'Ngũ Hành Sơn', 'Đại Lộc', '01294067734', 'Alibaba', 12, 'ffse1702021@st.fasttrack.edu.vn', '2018-10-02', '2018-10-02', 1),
(00018, 'Trần Dũng1', 'VT02', 'PDT', 2345, 'FFSE', 'đêm', 'teacher', 11111, 123456, 'Nữ', 'Rồi', 'Bố', 'Mẹ', 'java', 'NO', 'NO', 'WIN_20170811_18_14_54_Pro.jpg', 'Ngũ Hành Sơn', 'Đại Lộc', '01294067734', 'Alibaba', 12, 'long0202@gmail.com', '2018-10-03', '2018-10-01', 1),
(00019, 'Trần Lâm Phi Long', 'VT01', 'PDA2', 2345, 'FFSE', 'đêm', 'tầng 3', 11111, 123456, 'Nữ', 'Chưa', 'Bố', 'Mẹ', 'java', 'NO', 'NO', '1.jpg', 'Ngũ Hành Sơn', 'Đại Lộc', '01294067734', 'Alibaba', 12, 'long0202@gmail.com', '2018-10-02', '2018-10-02', 0),
(00020, 'Trần Dũng12', 'VT03', 'PDA2', 2345, 'FFSE', 'đêm', 'tầng 1', 11111, 123456, 'Nam', 'Chưa', 'Bố', 'Mẹ', 'java', 'NO', 'NO', 'WIN_20170811_18_14_54_Pro.jpg', 'Ngũ Hành Sơn', 'Đại Lộc', '01294067734', 'Alibaba', 12, 'long0202@gmail.com', '2018-10-03', '2018-10-03', 0),
(00021, 'Thanh Dung Thanh', 'VT03', 'PDA4', 2345, 'FFSE6', 'đêm', 'teacher', 11111, 123456, 'Nam', 'Rồi', 'Bố', 'Mẹ', 'java', 'NO', 'NO', 'WIN_20170811_18_14_54_Pro.jpg', 'Ngũ Hành Sơn', 'Đại Lộc', '01294067734', 'Alibaba', 12, 'long0202@gmail.com', '2018-10-03', '2018-10-03', 0),
(00022, 'Đào Tuyết', 'VT02', 'PDA2', 2345, 'FFSE', 'đêm', 'tầng 1', 11111, 123456, 'Thứ 3', 'Rồi', 'Bố', 'Mẹ', 'java', 'NO', 'NO', 'WIN_20170811_18_14_54_Pro.jpg', 'Ngũ Hành Sơn', 'Đại Lộc', '01294067734', 'Alibaba', 12, 'long0202@gmail.com', '2018-10-03', '2018-10-03', 1),
(00023, 'Công Giang', 'VT03', 'PDA1', 123456, 'FFSE', 'đêm', 'tầng 1', 11111, 123456, 'Thứ 3', 'Chưa', 'Bố', 'Mẹ', 'java', 'NO', 'NO', 'WIN_20170811_18_14_54_Pro.jpg', 'Ngũ Hành Sơn', 'Đại Lộc', '01294067734', 'Alibaba', 12, 'long0202@gmail.com', '2018-10-04', '2018-10-04', 0),
(00024, 'Thùy Dung', 'VT02', 'PDA4', 2345, 'FFSE', 'đêm', 'PM', 11111, 123456, 'Nữ', 'Chưa', 'Bố', 'Mẹ', 'java', 'NO', 'NO', 'WIN_20170811_18_14_54_Pro.jpg', 'Ngũ Hành Sơn', 'Đại Lộc', '01294067734', 'Alibaba', 12, 'long0202@gmail.com', '2018-10-04', '2018-10-04', 0),
(00025, 'Mộng Mơ', 'VT03', 'PIT', 2345, 'FFSE', 'đêm', 'tầng 1', 11111, 123456, 'Thứ 3', 'Chưa', 'Bố', 'Mẹ', 'java', 'NO', 'NO', 'WIN_20170811_18_14_54_Pro.jpg', 'Ngũ Hành Sơn', 'Đại Lộc', '01294067734', 'Alibaba', 12, 'long0202@gmail.com', '2018-10-04', '2018-10-04', 0);
...
CREATE TABLE IF NOT EXISTS `vai_tro_thanh_vien` (
  `ma_vai_tro` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `ten_vai_tro` varchar(30) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
ALTER TABLE `ho_so`
  MODIFY `ma_nhan_vien` int(5) unsigned zerofill NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=26;
--
...
--
ALTER TABLE `tinh_trang_hon_nhan`
  MODIFY `ma_tinh_trang_hon_nhan` int(11) NOT NULL AUTO_INCREMENT;
--
