...
public class Connect {
	...
	private static String strDatabase = "sinhvien";
	private static String strUser = "lp4";
	private static String strPwd = "1234";
	...
	static public void update(SinhVien sv, String ma) {
		Connection conn = getConnect();
		String sql = "UPDATE `sinhvien` SET `name`=?,`age`=?,`class`=?,`dress`=? WHERE masv=?";
		try {
			PreparedStatement pmt = conn.prepareStatement(sql);
