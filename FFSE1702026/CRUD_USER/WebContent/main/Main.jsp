	...
	<div class="container">
		<div>
			...
			<a style="float: right; margin: 10px"
				href="list?language=en_US<c:if test="${param.page !=null }" ><c:out value="&page=${param.page }" /></c:if>"><img
				style="height: 50px" src="C:\Users\Sang\Desktop\ame.jpg"
				alt="english" /></a> <a style="float: right; margin: 10px"
				href="list?language=vi_VN<c:if test="${param.page !=null }" ><c:out value="&page=${param.page }" /></c:if>"><img
				style="height: 50px" src="vnam.jpg" alt="vietnamese" /></a>
		</div>
