...
<c:url var="deletelink" value="/database/delete/" />
<div class="row">
	<div class="col-xs-12">
		<div class="card">
			<div class="card-header">
				<h4 class="card-title">
					<spring:message code="database.list" />
				</h4>
							...
							<tbody>
								<c:forEach var="database" items="${list }" varStatus="count">
									<tr>
										...
										<td><a href="${updatelink }${database.maDatabase }"
											...
											<button type="button"
												...
												data-toggle="modal"
												data-link="${deletelink }${database.maDatabase }"
												data-target="#danger">
