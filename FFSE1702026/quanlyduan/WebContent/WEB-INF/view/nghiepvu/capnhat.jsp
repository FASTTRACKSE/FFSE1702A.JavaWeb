		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title"><spring:message code="nghiepvu.update"></spring:message></h4>
				...
				<div class="card-body collapse in">
					<div class="card-block ">
						<c:url value="/nghiepvu/update" var = "update" />
						<form:form cssClass="form-horizontal" modelAttribute="nghiepvu" method="POST" action="${update}" >
							...
							<div class="row">
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										...
										<div class="controls">
											<form:input readonly="true" path="maNghiepVu" cssClass="form-control round"/>
