...
<c:url var="createlink" value="/vaitro/create" />
<c:url var="updatelink" value="/vaitro/update/" />
<c:url var="deletelink" value="/vaitro/delete/" />
<div class="row">
    <div class="col-xs-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><spring:message code="role.list" /></h4>
            ...
            <div class="card-body collapse in">
                ...
                <c:if test="${message !=null }">
                    ...
                    <p><a href="${createlink }"><span class="text-bold-600"><spring:message code="role.add" /></span></a> </p>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th><spring:message code="role.action" /></th>
                                </tr>
                            </thead>
                            <tbody>
                            <c:forEach var="vaitro" items="${list }" varStatus="count"   >
                                <tr>
                                    <th scope="row">${count.count  }</th>
                                    <td>${vaitro.maVaiTro }</td>
                                    <td>${vaitro.tenVaiTro }</td>
                                    <td><a href="${updatelink }${vaitro.maVaiTro }"
											...
											<button type="button"
												...
												data-toggle="modal"
												data-link="${deletelink }${vaitro.maVaiTro }"
												data-target="#danger">
