...
<div class="app-content content container-fluid">
	<div class="content-wrapper">
		...
		<div class="content-body">
			<!-- Form search -->
			<div class="row mb-2">
				<form class="col-xs-12" action='<c:url value="/chuc-danh/"></c:url>'
					...
					<div class="pull-right">
						<a href="<c:url value="/chuc-danh/them-moi"></c:url>"
										...
										<script type="text/javascript">
										   window.onload = function () {
										      ...
										      $("#datatable").dataTable({
										    	  ...
										    	  "order": [[2 , "asc" ], [0, "desc"]],
										          "bServerSide" : true,
										          "sAjaxSource" : "/ffse-fbms/quanlyphanquyen/quan-ly-chuc-danh/view/getListChucDanh",
										      });
										   };				   
										</script>
										<%-- <c:if test="${not empty listChucDanh}">
											<c:forEach var="item" items="${listChucDanh}" begin="0"
												varStatus="counter">
												<tr>
													...
													<td class="tbl_actions"><a
														href="<c:url value="/chuc-danh/sua/${item.maChucDanh}" />" title="Sửa">
															<i class="fa fa-pencil-square-o blue" aria-hidden="true"></i>Sửa
													</a> <a href="<c:url value="/chuc-danh/xoa/${item.maChucDanh}" />" title="Xóa"
