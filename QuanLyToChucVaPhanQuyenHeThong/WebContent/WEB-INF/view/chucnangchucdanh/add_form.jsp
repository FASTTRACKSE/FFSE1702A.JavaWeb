	...
	<div class="content-wrapper">
		...
		<div class="content-header row">
			<div class="content-header-left col-md-12 col-xs-12 mb-2">
				<h3 class="content-header-title mb-0">Thêm mới chức năng chức danh</h3>
				<div class="row breadcrumbs-top">
					<div class="breadcrumb-wrapper col-xs-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Thêm mới chức năng chức danh</li>
						</ol>
					</div>
				</div>
			</div>
					...
					<div class="card">
						...
						<form style="overflow: hidden; padding-top: 15px;" method="POST" action="">
							<div class="form-group col-sm-6">
							  	...
							  	<input class="form-control" name="_maChucDanh" placeholder="Mã chức danh" required="required"/>
							</div>
