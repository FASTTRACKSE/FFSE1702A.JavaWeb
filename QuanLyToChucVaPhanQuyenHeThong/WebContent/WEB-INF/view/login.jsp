...
<body data-open="click" data-menu="vertical-menu" data-col="1-column"
						...
						<div class="card border-grey border-lighten-3 m-0">
							<div class="card-header no-border">
								<div class="card-title text-xs-center">
									<div class="p-1">
										<img
											src="<c:url value="resources/images/logo/stack-logo-dark.png" />"
											alt="branding logo">
									</div>
								</div>
								<h6
							...
							<div class="card-body collapse in">
								<div class="card-block">
									...
									<form class="form-horizontal form-simple" name='loginForm'
							...
							<div class="card-footer">
								<div class="">
									<p class="float-sm-left text-xs-center m-0">
										<a href="recover-password.html" class="card-link">Recover
											password </a>
									</p>
									<p class="float-sm-right text-xs-center m-0">
										New to Stack? <a href="register-simple.html" class="card-link">Sign
											Up </a>
									</p>
								</div>
							</div>
	...
	<script
		src="<c:url value="resources/vendors/js/forms/icheck/icheck.min.js " />"
		type="text/javascript ">
   </script>
	<script
		src="<c:url value="resources/vendors/js/forms/validation/jqBootstrapValidation.js "/>"
		type="text/javascript ">
   </script>
	<!-- END PAGE VENDOR JS-->
	<!-- BEGIN STACK JS-->
	...
	<!-- BEGIN PAGE LEVEL JS-->
	<script
		src="<c:url value="resources/js/scripts/forms/form-login-register.js "/>"
		type="text/javascript ">
   </script>
	<!-- END PAGE LEVEL JS-->
