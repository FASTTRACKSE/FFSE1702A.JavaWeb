...
<div class="app-content content container-fluid">
	<div class="content-wrapper">
		...
		<form:form action="documentSave" method="POST" modelAttribute="document" enctype="multipart/form-data"
			...
			<div class="form-body">
				...
				<c:if test="${not empty id}">
					<div class="form-group row">
						<label class="col-md-3 label-control" for="projectinput5">
							ID </label>
						<div class="col-md-9">
							<form:input path="id" class="form-control" id="projectinput5"
								value="${document.ten_tai_lieu}" />
							<form:hidden path="id" />
						</div>
					</div>
				</c:if>
				...
				<!-- ///////////////////// -->
			 	...
			 	<div class="form-actions">
					<button type="submit" class="btn btn-success mr-1"> <spring:message code="label.submit" />
					</button> 
					 
					<button formaction="documentSave/draft" class="btn btn-info mr-1">
						<spring:message code="label.draft" />
					</button>
					<a href="<%=request.getContextPath()%>/index"
						class="btn btn-danger mr-1"><spring:message code="label.cancel" /></a>
				</div>
			</div>
		</form:form>
