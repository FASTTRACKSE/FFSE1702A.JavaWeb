      ...
      <div class="navbar-wrapper">
         <div class="navbar-header">
            <ul class="nav navbar-nav">
               ...
               <li class="nav-item"><a href="index" class="navbar-brand"><img alt="stack admin logo" src="resources/images/logo/stack-logo.png" class="brand-logo" />
         ...
         <div class="navbar-container content container-fluid">
            <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
			 ...
			 <!-- ========================= -->
                  ...
                  <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="resources/images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></span><span class="user-name">admin</span></a>
   ...
   <div data-scroll-to-active="true" class="main-menu menu-fixed menu-light menu-accordion menu-shadow">
      <div class="main-menu-content">
         <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
            ...
            <li class=" nav-item"><a href="index"><i class="ft-home"></i><span data-i18n="" class="menu-title">Dashboard</span></a>
               <ul class="menu-content">
                  <li><a href="list" class="menu-item">Tài liệu của tôi</a>
                  </li>
                  <li><a href="#" class="menu-item">nháp của tôi </a>
                  </li>
                  <li><a href="#" class="menu-item">Tài liệu chờ phê duyệt</a>
                  </li>
                  <li><a href="#" class="menu-item">Tài liệu công khai</a>
                  </li>
               </ul>
            </li>
         </ul>
