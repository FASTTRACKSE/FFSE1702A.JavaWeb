                  ...
                  <div class="card">
                     ...
                     <div class="card-body collapse in">
                        <div class="card-block card-dashboard ">
                           <p class="card-text">Example of a table with bootstrap default styling. By default any table with <code>.table</code> class has <em>transparent</em> background color.</p>
                        </div>
               ...
               <div class="col-xs-12">
                  <div class="card">
                     ...
                     <div class="card-body collapse in">
                        ...
                        <div class="card-block card-dashboard">
                           <p>Apart form bootstrap color options you can also use Stack Admin color palette options, To set the selected bg color lighten use <code>.bg-*</code> where <code>*</code> is the value of your selected color from palette, and with that use <code>.bg-lighten-*</code> or <code>.bg-darken-*</code> class where <code>*</code> is the value between '1-5' of your selected lighten/darken color from stack color palette. So for color lighten 4 bg class will be <code>.bg-lighten-4</code>.</p>
                        </div>
                        <div class="table-responsive">
                           <table class="table mb-0">
            ...
            <div class="row" id="footer-styling">
               <div class="col-xs-12">
                  <div class="card">
                     ...
                     <div class="card-body collapse in">
                        <div class="card-block card-dashboard">
                           <p class="card-text">Example of a custom table <em>footer</em> styling. Table footer supports default contextual and custom background colors available in <a href="colors-primary-palette.html" target="_blank">bootstrap brand colors</a>. To use bootstrap brand color in the table footer, add <code>.bg-*</code> class to the footer row. All border and text colors will be automatically adjusted.</p>
                        </div>
                        <div class="table-responsive">
                           <table class="table">
                              <tbody>
            ...
            <div class="row" id="contingent">
               <div class="col-xs-12">
                  <div class="card">
                     ...
                     <div class="card-body collapse in">
                        <div class="card-block card-dashboard">
                           <p class="card-text">Example of Contingent classes for table <code>rows</code>. Contingent classes are used to color table rows or individual cells. It use Bootstrap by default colors.</p>
                        </div>
                        <div class="table-responsive">
                           <table class="table">
                              <thead>
                        ...
                        <div class="card-block card-dashboard">
                           <p>Stack Admin color palette options can be use also for the contingent classes, To set the selected bg color lighten use <code>.bg-*</code> where <code>*</code> is the value of your selected color from palette, and with that use <code>.bg-lighten-*</code> or <code>.bg-darken-*</code> class where <code>*</code> is the value between '1-5' of your selected lighten/darken color from stack color palette. So for color lighten 4 bg class will be <code>.bg-lighten-4</code>.</p>
                        </div>
                        <div class="table-responsive">
                           <table class="table mb-0">
                              <thead>
            ...
            <div class="row" id="row-color">
               <div class="col-xs-12">
                  <div class="card">
                     ...
                     <div class="card-body collapse in">
                        <div class="card-block card-dashboard">
                           <p class="card-text">Example of <em>custom colors</em> for table rows. Add custom background colors available in <a href="colors-primary-palette.html" target="_blank">bootstrap brand colors</a>. To use bootstrap brand color in the table footer, add <code>.bg-*</code> class to the footer row. All border and text colors will be automatically adjusted.</p>
                        </div>
                        <div class="table-responsive">
                           <table class="table">
                              <thead>
                        ...
                        <div class="card-block card-dashboard">
                           <p>Stack Admin color palette options can be use also for the custom row color, To set the selected bg color lighten use <code>.bg-*</code> where <code>*</code> is the value of your selected color from palette, and with that use <code>.bg-lighten-*</code> or <code>.bg-darken-*</code> class where <code>*</code> is the value between '1-5' of your selected lighten/darken color from stack color palette. So for color lighten 4 bg class will be <code>.bg-lighten-4</code>.</p>
                        </div>
                        <div class="table-responsive">
                           <table class="table">
                              <thead>
            ...
            <div class="row" id="table-formatting">
               <div class="col-xs-12">
                  <div class="card">
                     ...
                     <div class="card-body collapse in">
                        <div class="card-block card-dashboard">
                           <p class="card-text">Example of a table with custom <em>formatting</em> color. Add custom background colors available in <a href="colors-primary-palette.html" target="_blank">bootstrap brand colors</a>. To use bootstrap brand color in the table footer, add <code>.bg-*</code> class to the footer row. All border and text colors will be automatically adjusted.</p>
                        </div>
                        <div class="table-responsive">
                        ...
                        <div class="card-block card-dashboard">
                           <p>Stack Admin color palette options can be use also for the custom table formatting, To set the selected bg color lighten use <code>.bg-*</code> where <code>*</code> is the value of your selected color from palette, and with that use <code>.bg-lighten-*</code> or <code>.bg-darken-*</code> class where <code>*</code> is the value between '1-5' of your selected lighten/darken color from stack color palette. So for color lighten 4 bg class will be <code>.bg-lighten-4</code>.</p>
                        </div>
                        <div class="table-responsive">
            ...
            <div class="row" id="formatting-options">
               <div class="col-xs-12">
                  <div class="card">
                     ...
                     <div class="card-body collapse in">
                        <div class="card-block card-dashboard">
                           <p class="card-text">Table with custom formatting color supports all default table layouts and options. In this example our table displays all possible borders, striped rows and changes background color on row hover.</p>
                        </div>
                        <div class="table-responsive">
                        ...
                        <div class="card-block card-dashboard">
                           <p>Stack Admin color palette options can be use also for the custom table formatting options, To set the selected bg color lighten use <code>.bg-*</code> where <code>*</code> is the value of your selected color from palette, and with that use <code>.bg-lighten-*</code> or <code>.bg-darken-*</code> class where <code>*</code> is the value between '1-5' of your selected lighten/darken color from stack color palette. So for color lighten 4 bg class will be <code>.bg-lighten-4</code>.</p>
                        </div>
                        <div class="table-responsive">
