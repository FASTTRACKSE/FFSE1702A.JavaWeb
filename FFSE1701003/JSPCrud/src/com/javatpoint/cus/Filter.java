...
public abstract class Filter {
	...
	/**
	 * Member identifier for the number of pages you have in the navigation (i.e 2
	 * to 11 or 3 to 12 etc.)
	 */
	...
	public List getElements() {
		...
		// If you use Hibernate, you don't need to worry for null check since if there
		// are no results then an empty collection is returned
		return query.list();
	}
