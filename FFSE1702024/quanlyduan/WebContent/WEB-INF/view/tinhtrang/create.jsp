		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title"><spring:message code="tinhtrang.add"></spring:message></h4>
				...
				<div class="card-body collapse in">
					<div class="card-block ">
						...
						<form:form cssClass="form-horizontal" modelAttribute="tinhtrang" method="POST" action="create" >
							...
							<div class="row">
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										...
										<div class="controls">
											<form:input path="maTinhTrang" cssClass="form-control round"/>
									...
									<div class="form-group">
										...
										<div class="controls">
											<form:input path="tenTinhTrang" cssClass="form-control round"/>
