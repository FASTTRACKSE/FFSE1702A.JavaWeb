...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 04, 2018 lúc 07:32 AM
...
INSERT INTO `chuc_danh` (`ma_vai_tro`, `ten_vai_tro`) VALUES
('GD', 'Giám đốc'),
('NV', 'Nhân viên'),
('PGD', 'Phó Giám đốc'),
('PP', 'Phó phòng'),
...
INSERT INTO `ho_so` (`ma_nhan_vien`, `ho_ten`, `ma_vai_tro`, `ma_phong_ban`, `luong`, `sdt`, `so_hop_dong`, `ma_gioi_tinh`, `tinh_trang_hon_nhan`, `img`, `dia_chi_hien_tai`, `lien_he_khac`, `ten_ngan_hang`, `so_tai_khoan`, `email`, `ngay_tham_gia`, `ngay_sinh`, `is_delete`) VALUES
(00001, 'quangNCQ', 'GD', 'PDA1', 121212212, 1341431, 1212222, 'Nữ', 'Đã đính hôn', '3.PNG', 'da nang', 'wwwwaaacdsa', 'dong a', 1421414, 'FFSE1702024@st.fasttrack.edu.vn', '2018-10-17', '2018-10-02', 0),
(00002, 'fdsfa', 'NV', 'PDA2', 121212212, 1341431, 1212222, 'Nữ', 'Single', '1.PNG', 'da nang1', 'wwwwaaa', 'dong a', 1421414, 'ffse1702024@st.fasttrack.edu.vn', '2018-10-11', '2018-10-20', 0),
(00003, 'Trần CC', 'PGD', 'PDT', 121212212, 1341431, 1212222, 'Thứ 3', 'Đã đính hôn', '3.PNG', 'da nang', 'wwwwaaadsadsad', 'dong a', 1421414, 'FFSE1702024@st.fasttrack.edu.vn', '2018-10-01', '2018-10-01', 1);
...
--
-- Cấu trúc bảng cho bảng `vai_tro_thanh_vien`
--
...
--
-- Chỉ mục cho bảng `vai_tro_thanh_vien`
--
...
--
ALTER TABLE `ho_so`
  MODIFY `ma_nhan_vien` int(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
