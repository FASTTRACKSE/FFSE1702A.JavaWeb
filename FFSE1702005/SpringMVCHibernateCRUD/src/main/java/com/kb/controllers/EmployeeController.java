...
public class EmployeeController {
	...
	@RequestMapping(value = {"/employees"}, method = RequestMethod.GET, produces="application/x-www-form-urlencoded;charset=UTF-8")
	...
	@RequestMapping(value = "/employee/add", method = RequestMethod.POST, produces="application/x-www-form-urlencoded;charset=UTF-8")
