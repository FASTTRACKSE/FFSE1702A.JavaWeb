...
<body style="margin:100px;">
	<h1 style="text-align: center; color: red">Add new Student:</h1>
	<div style="text-align: center;">
	<a href="<c:url value="/index" />">List Student</a>
	</div>
	
	<c:url value="/studentSave" var="studentSave" />
	<form:form action="${studentSave}" method="POST"
		modelAttribute="student" class="form-horizontal">
